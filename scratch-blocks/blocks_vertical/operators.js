...
Blockly.Blocks['operator_square'] = {
  /**
   * Block for calculating the square of a number.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.math,
...
Blockly.Blocks['operator_sqrt'] = {
  /**
   * Block for calculating the square root of a number.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.OPERATOR_SQRT,
      "args0": [
        {
          "type": "input_value",
          "name": "NUM"
